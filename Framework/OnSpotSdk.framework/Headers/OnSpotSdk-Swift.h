...
#ifndef ONSPOTSDK_SWIFT_H
#define ONSPOTSDK_SWIFT_H
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OnSpotaCore * _Nonnull sharedInstance;)
+ (OnSpotaCore * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
